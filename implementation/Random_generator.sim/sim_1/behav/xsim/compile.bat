...
REM
REM Generated by Vivado on Fri Dec 19 19:05:07 +0200 2025
...
echo "xvlog --incr --relax -prj tb_trng_vlog.prj"
call xvlog  --incr --relax -prj tb_trng_vlog.prj -log xvlog.log
